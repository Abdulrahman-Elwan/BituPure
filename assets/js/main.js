  ...
  const productData = [
    {
      ...
      categories: [
        ...
        { name: "القصارة والبناء", link: "allProduct.html?category=plastering" },
        { name: "العزل الحراري", link: "allProduct.html?category=thermal-insulation" },
        { name: "التروية عالية الدقه", link: "allProduct.html?category=precision-grouting" },
        { name: "مواد معالجة الأسطح والتشطيب", link: "allProduct.html?category=surface-treatment" },
        { name: "طبقات الحماية الواقيه", link: "allProduct.html?category=protective-coatings" },
